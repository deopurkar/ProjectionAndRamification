...
\end{proposition}
We invite the reader to look at \autoref{fig:quarticscroll} for an illustration of the configuration formed by the conic $Q$, the Jacobian $R$, the dual of the Hermite curve $E^\perp$, and the triangles $(L_1,L_2,L_3)$ and $(M_1,M_2,M_3)$.
\begin{proof}
...
\begin{figure}
  ...
  \caption{
    An illustration of the unique pair of polar conjugate triangles of Reye lines associated to a net of conics as proved in \autoref{prop:quarticscroll}.
    The net of conics includes the distinguished conic $Q$, seen here as a hyperbola (dotted black).
    The Jacobian cubic $R$ (purple) and the dual of the Hermite cubic $E^\perp$ (orange) intersect in 6 points on $Q$ (4 of which are real and visible), and 3 other collinear points, two of which, say $p_1$ and $p_2$, are marked (red), and the third, say $p_3$, is at infinity.
    The Reye lines forming the two polar conjugate triangles (dashed green and blue) come in conjugate pairs, and the lines in each pair intersect in $p_1$, $p_2$, and $p_3$.
  }
