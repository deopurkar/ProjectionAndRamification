...
The integers $n_1 > n_2$ are such that we have vanishing $H^0(C_1, E_n|_{C_1}) = 0$ for all $n \geq n_1$ and $H^0(C_2, E_n|_{C_2}) = 0$ for $n \leq n_2$.
For convenience, we increase $n_1$ and decrease $n_2$ so that the vanishing on $C_1$ holds for all $n \geq n_1 - (w_1-2g_1)$ and on $C_2$ for all $n \leq n_2 + (w_2-2g_2)$.
Define
\[ d_1 = w_1 - n_1r, \quad d_2 = w_2 + n_2r,\text{ and } b = n_1 - n_2,\]
as before.
...
and observe that we have vanishings $H^0(C_1, E'_{n}|_{C_1}) = 0$ for $n \geq n_1'$ and $H^0(C_2, E'_{n}|_{C_2}) = 0$ for $n \leq n_2'$.
We also set
\[ b' = n_1' - n_2' = b(1+r).\]
...
Before we define the rational map, we first identify the open set in ${\mathcal G}(r+1, \mathcal E)|_0$ where it can be defined.
...
r_n \from \det V_n \to \mathcal \pi_*(\mathcal E_n \otimes \det \mathcal E_n \otimes \omega^*_{X_S/S}) = \pi_*(\mathcal E'_{rn}).
\end{equation}
