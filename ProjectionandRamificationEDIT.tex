...
To our knowledge, this question first appeared in the work of Flenner and Manaresi \cite{fle.man:98}.
...
\begin{proof}
  ...
  (The fact that $p_1, p_2, p_3$ are collinear is not surprising---it is because any two conjugate triangles are linearly perspective \cite[Theorem~2.1.9]{dol:12}).
  ...
  The concurrence of the three lines, along with the equality $p_3^\perp = x_i$, yields the system of equations on $\Pic E$
  \begin{align*}
  ...
  Note that $\Delta_2$, $\Delta_3$, and $p_1^\perp$ are concurrent lines in $\P S$, and the line $p_1^\perp$ is represented by $x_1 \in \P S^*$.
  But $\Delta_1$, $\Delta_2$, and $\Delta_3$ are not concurrent, so $\Delta_1 \neq x_1$.
  Suppose the involution of $E$ induced by $E \to R$ is given by the addition of $\epsilon_0 \in \Pic E [2]^*$.
  Then the same argument shows that $\nabla_1 \neq x_1$, and hence $\Delta_1 \neq x_1 + \epsilon_0$.
  Therefore, the only two possible solutions for $\Delta_1$ are $x_1 + \epsilon$ for $\epsilon \in \Pic E [2] \setminus \{0, \epsilon_0\}$.
  The proof is now complete.  
\end{proof}
