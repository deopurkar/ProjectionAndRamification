...
In \autoref{sec:generic}, we prove \autoref{thm:rationalnormalscrolls} as \autoref{thm:actualrationalnormalscrolls}, after treating some low degree examples by hand in \autoref{sec:lowdegree}, introducing limit linear series for vector bundles of higher rank in \autoref{sec:lls}, and defining the projection-ramification map for limit linear series in \autoref{sec:prnongeneric} and \autoref{sec:prlls}.
