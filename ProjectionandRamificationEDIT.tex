...
\begin{tikzcd}
  ...
  0 \arrow{r}& E \otimes K_C \arrow{r}& P(E) \arrow{r}& E \arrow{r}& 0,
\end{tikzcd}
\end{equation}
...
Set $c = \pi(x)$, and let $X_c$ be the fiber of $\pi \from X \to C$ over $c$.
Let $t$ be a uniformizer of $C$ at $c$.
Then, in an open set of $X$ containing $X_c$, we have $s = t s_1$ for a section $s_1$ of $\O_X(1)$.
Observe that, we have $\sing(v(s)) \cap F = v(s_1) \cap F$, and therefore, the fiber $R_c$ of $R \to C$ over $c$ is the hyperplane in $X_c$ cut out by $s_1$.
...
As before, let $c$ be a point of $C$, and $t$ a uniformizer of $C$ at $c$.
