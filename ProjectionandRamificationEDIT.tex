...
\begin{proof}
  ...
  Consider the point of $\Gr(r+1, H^0(\P^1, E))$ represented by the vector space $V \subset H^0(\P^1, E)$ spanned by $(r+1)$ sections $v_0, \dots, v_r$ defined as follows.
  ...
  We have
  \[ R_\epsilon = \det M(v_0 + \epsilon w_0, \dots, v_r + \epsilon w_r) = R + \epsilon S(w_0, \dots, w_r),\]
  where
  ...
  For $1 \leq i \leq r$ and $0 \leq j \leq r$, let $E_{i,j} \in H^0(\P^1, E)^{r+1}$ be the element corresponding to $(w_0, \dots, w_r)$ where $w_j = X_i$ and $w_\ell = 0$ for all $\ell \neq j$.
  For $i \neq j$ and $0 \leq j < r$ and $q \in H^0(\P^1, \O(2))$, by direct calculation we get
  ...
  Similarly, we get
  \[ S\left(qE_{i,r}\right) = - \frac{(x-a_1)^2 \cdots (x-a_r)^2}{(x-a_i)^2} \cdot [q, (x-a_i)^2] \cdot X_i,\]
  and
