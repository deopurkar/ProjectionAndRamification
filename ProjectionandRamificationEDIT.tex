...
A.D. thanks the Australian Research Council for the grant number \emph{DE180101360} that supported a part of this project.
...
We also thank Izzet Coskun for enlightening discussions related to the project.
...
\begin{remark}\label{rem:richelot}
  The space $\Hilb^3 \P S$ and the birational involution (called the Richelot involution)
  ...
  Intersecting the lines $\ell_i$ with $Q$ for $i = 1, 2, 3$ gives a triple of pairs on $Q \cong \P^1$.
  ...
  Thus, $\Hilb^3 \P S$ is birational to the moduli space of genus 2 curves along with an isotropic subspace of two torsion points in its Jacobian.

  Since general principally polarized abelian surfaces are Jacobians of genus 2 curves, $\Hilb^3 \P S$ is also birational to the moduli of $(A, G)$, where $A$ is a principally polarized abelian surface and $G \subset A[2]$ is a maximal isotropic subspace for the Weil pairing.
  ...
  In this interpretation, the involution $\tau$ corresponds to the action of $\frac{1}{\sqrt 2} \begin{pmatrix} 0 & I_2 \\ -2 I_2 & 0 \end{pmatrix} \in \operatorname{Sp}(4, \R)$ (again, see \cite[Page~2]{muk:12}).
  ...
  Now the space is the moduli space of $(A, \psi)$, where $A$ is a principally polarized abelian surface and $\psi \from \F_2^2 \to A[2]$ is an isomorphism onto a maximal isotropic subspace (equivalently, consider maximal isotropic subspaces along with a basis).
  This space is birational to $H_2 / \Gamma_1(2)$ where $\Gamma_1(2) \subset \operatorname{Sp}(4, \Z)$ is defined by the congruence conditions $A - I_2 \equiv 0 \pmod 2$ in addition to $C \equiv 0 \pmod 2$.
