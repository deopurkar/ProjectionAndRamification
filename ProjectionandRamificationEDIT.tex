...
\begin{proof}
  ...
  We conclude that $\dim P \leq \dim |L|$, and $k \leq n-r+1$.
  ...
  Let $D \in |L|$ be general, in particular, not in the image of $P^B \to |L|$.
  By Bertini's theorem $D$ is non-singular away from $B$.
  Thus, for any $x \in X$, the point $(x, D) \in X \times |L|$ does not lie in $P$.
  For $x \in B$, this is because $D$ is not in the image of $P^B$, and for $x \not \in B$, this is because $D$ is non-singular at $x$.
  We conclude that $D$ does not lie in the image of $P \to |L|$.
