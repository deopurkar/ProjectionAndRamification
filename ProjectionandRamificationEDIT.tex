...
In the same section, we derive explicit formulas for the ramification divisors for scrolls (\autoref{sec:prscroll}), give the examples advertised in \autoref{thm:counterexamples} (\autoref{sec:failure}), and treat the threefold scrolls (\autoref{sec:eccentric_threefolds}).
