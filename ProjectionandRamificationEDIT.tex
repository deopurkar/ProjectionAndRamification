...
For scrolls, the story is complicated, as evidenced by \autoref{thm:counterexamples}.
...
% In higher dimensions, the story is complicated, as evidenced by 
But for generic scrolls of high degree, we have maximal variation.
\begin{maintheorem}
...
The proof of \autoref{thm:rationalnormalscrolls} goes by degeneration using the spaces of (linked) limit linear series for vector bundles of higher rank developed by Teixidor i Bigas \cite{tei-i-big:91} and Osserman \cite{oss:14}.
