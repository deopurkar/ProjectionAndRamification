...
\begin{proof}
  ...
  In particular, $\widetilde P$ is irreducible of the same dimension as $P$, and admits a birational morphism $\widetilde P \to P$.
  Let $\widetilde P^{\rm sing} \subset \widetilde P$ be the pre-image of the singular locus $\widetilde X^{\rm sing}$ of $X$.
  ...
  By Bertini's theorem, $D$ is non-singular, that is, not in the image of $\widetilde P$, and hence $\widetilde P \to |L|$ is not surjective.
