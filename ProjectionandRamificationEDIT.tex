...
\begin{proof}
  ...
  In particular, $W_{n_1} \subset H^0(C_1, E_1(a))$ is the image of an $(r+1)$-dimensional subspace $V(w) \subset H^0(C_1, E_1)$ with vanishing sequence $(0, \dots, 0, 1)$, and $W_{n_2} \subset H^0(C_2, E_2(b-a))$ is the image of an $(r+1)$-dimensional subspace $\Lambda(w) \subset H^0(C_2, E_2(1))$ with vanishing sequence $(0,1,\dots,1)$.
  Furthermore, the gluing condition implies that $V(w)$ is in fact the image of an $(r+1)$-dimensional subspace of the kernel of the map
  \[ E_2'(1) \to E_2'(1)/W^1.\]
