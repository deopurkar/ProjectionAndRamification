...
\[
  \rho \from \Gr(n-r-1, n+1) \dashrightarrow |K_X + (r+1)H|.
\]
We can rephrase in terms of $\rho$ the questions raised in the introduction: is $\rho$ generically finite, and if so, what is the degree of $\rho$?
