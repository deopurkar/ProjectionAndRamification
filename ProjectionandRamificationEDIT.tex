...
\begin{remark}\label{def:Jacobian}
...
The (\'etale) degree 2 map $E \to D \cong R$ gives a non-trivial two-torsion element $\eta \in \Jac(R)[2]$
...
\begin{proof}
  ...
  \[ 2y \sim 2z.\]
  Therefore, $y - z$ is a (non-trivial) two torsion element in $\Jac(R)$.
...
\begin{proof}[Proof of \autoref{prop:veronese}]
  Let $U \subset \P H^0(\P^2, \O(3))^*$ be the locus of smooth cubic curves, $J \to U$ be the universal Jacobian, $J[2] \subset J$ the closed subscheme of two-torsion classes, and $J[2]^* \subset J[2]$ the open and closed subscheme of non-trivial two-torsion classes.
