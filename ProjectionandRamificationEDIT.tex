...
\end{maintheorem}
Recall that the dual variety $X^* \subset {\P^n}^*$ is the locus of hyperplanes $H \subset \P^n$ such that $X \cap H$ is singular.
...
Thus, even for surfaces, \autoref{item:dual} of \autoref{thm:main} covers new ground.
