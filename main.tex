...
%For example, is $\rho$ (generically) injective? Is it generically finite? What is its degree? What are its fibers? 
...
The question of maximal variation appeared first in the work of Flenner and Manaresi in connection with the St\"uckrad-Vogel cycle \cite{fle.man:98}. 
...
\end{maintheorem}
The proof of \autoref{thm:rationalnormalscrolls} proceeds by a degeneration of the scroll, and uses the spaces of (linked) limit linear series for vector bundles of higher rank, developed by Teixidor i Bigas \cite{tei-i-big:91} and Osserman \cite{oss:14}.
...
\todo{Summarize the enumerative problem in a paragraph.}
...
\todo{Summarize further questions in a paragraph.}
