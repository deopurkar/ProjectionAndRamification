...
For $r \geq 2$, let $X = \P^{r-1} \times \P^1$ embedded in $\P^{2r-1}$ by the Segre embedding.
Then $X$ is neither incompressible nor is $X^*$ a hypersurface, and yet $\rho$ is dominant (\autoref{prop:segre}).

Zak \cite{zak:} has alluded to the existence of varieties for which maximal variation fails.
