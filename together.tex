...
\begin{abstract}
  ...
  By a degeneration argument involving limit linear series on vector bundles, we show that this map is also dominant for most (but not all!) varieties of minimal degree.  \end{abstract}
